...
def test_permutation_35168327():
    hamlet_permutation_35168327 = permutation_cipher(hamlet, [3, 5, 1, 6, 8, 3, 2, 7])
    hamlet_cracked, key = brute_force_permutation_cipher(hamlet_permutation_35168327, quadgrams)
    assert hamlet_cracked == hamlet
